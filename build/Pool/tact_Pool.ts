...
export type PremiumRateChanged = {
    $$type: 'PremiumRateChanged';
    tokenId: bigint;
    deviationRate: bigint;
    premiumRate: bigint;
}

export function storePremiumRateChanged(src: PremiumRateChanged) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeUint(3766157688, 32);
        b_0.storeUint(src.tokenId, 64);
        b_0.storeInt(src.deviationRate, 257);
...
export function loadPremiumRateChanged(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 3766157688) { throw Error('Invalid prefix'); }
    let _tokenId = sc_0.loadUintBig(64);
    let _deviationRate = sc_0.loadIntBig(257);
    let _premiumRate = sc_0.loadIntBig(257);
    return { $$type: 'PremiumRateChanged' as const, tokenId: _tokenId, deviationRate: _deviationRate, premiumRate: _premiumRate };
}

function loadTuplePremiumRateChanged(source: TupleReader) {
    let _tokenId = source.readBigNumber();
    let _deviationRate = source.readBigNumber();
...
function storeTuplePremiumRateChanged(source: PremiumRateChanged) {
    let builder = new TupleBuilder();
    builder.writeNumber(source.tokenId);
    builder.writeNumber(source.deviationRate);
...
function dictValueParserPremiumRateChanged(): DictionaryValue<PremiumRateChanged> {
    return {
        serialize: (src, buidler) => {
            buidler.storeRef(beginCell().store(storePremiumRateChanged(src)).endCell());
        },
        parse: (src) => {
            return loadPremiumRateChanged(src.loadRef().beginParse());
        }
    }
}
...
async function Pool_init(deployId: bigint) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
...
const Pool_types: ABIType[] = [
    ...
    {"name":"PremiumRateChanged","header":3766157688,"fields":[{"name":"tokenId","type":{"kind":"simple","type":"uint","optional":false,"format":64}},{"name":"deviationRate","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"premiumRate","type":{"kind":"simple","type":"int","optional":false,"format":257}}]},
