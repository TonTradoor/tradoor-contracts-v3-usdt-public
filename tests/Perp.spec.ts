...
import { adlPerpPosition, cancelPerpOrder, createDecreasePerpOrder, createIncreasePerpOrder, createTpSlPerpOrder, executePerpOrder, liquidatePerpPosition, setPremiumRateSample, updatePrice } from './lib/PerpHelper';
...
describe('LP', () => {
    ...
    // it("should search premium rate", async() => {
    ...
    //         let trxResult = await setPremiumRateSample(executor, samples.slice(start, end));
