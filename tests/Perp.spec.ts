...
describe('LP', () => {
    ...
    it('should claim funding fee', async () => {
        ...
        /* =========================== increase long perp ================================ */
        blockchain.now = blockchain.now + 40 * 60; // H:40
        ...
        /* =========================== increase short perp ================================ */
        blockchain.now = blockchain.now + 10 * 60; // H:50
        ...
        // create order
        const createIncreaseResult2 = await createIncreaseLPOrder(user0, lpLiquidity2, executionFee);
        ...
        expect(position2?.liquidity).toEqual(toJettonUnits(lpLiquidity + lpLiquidity2));
        console.log('lp data after increase:', executeIncreaseResult2.positionDataAfter);

        /* =========================== decrease short perp ================================ */
        blockchain.now = blockchain.now + 20 * 60; // H+1:10
